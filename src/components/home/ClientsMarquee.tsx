  ...
  return (
    <div className="flex w-max items-center gap-6 animate-marquee">
      {items.map((b, i) => (
        <div
          key={`${b.slug}-${i}`}
          className="bg-white rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.09)] h-45 w-[300px] shrink-0 flex items-center justify-center p-10"
        >
...
export default function ClientsMarquee() {
  return (
    <section className="pt-[40px] pb-[80px] bg-white overflow-hidden">
